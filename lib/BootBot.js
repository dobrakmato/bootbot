...
class BootBot extends EventEmitter {
  ...
  /**
   * Set array of whitelisted domains for use in Messenger Extensions.
   * Facebook docs: https://developers.facebook.com/docs/messenger-platform/reference/messenger-profile-api/domain-whitelisting
   * @param domains {Array.<String>} array of domains
   */
